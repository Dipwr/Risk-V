...
# =====================================================================
# GRAPHIC FONT ENGINE & SUBROUTINES (320x200 Resolution)
# =====================================================================

# Clears the entire Graphic RAM (320x200 = 64,000 pixels). 8,000 iterations.
clear_screen_sub:
    mv  t0, s5              # t0 = GRAPHIC_RAM
    li  t1, 8000            # 64000 pixels / 8 per iteration
clear_loop:
    sw  s8, 0(t0)
    sw  s8, 4(t0)
    sw  s8, 8(t0)
...
dc_next3:
    ...
    addi    t4, t4, 1280        # Next row down (320 pixels * 4 bytes)
    addi    t2, t2, 1
    li  t5, 5               # 5 rows
    blt t2, t5, draw_row
