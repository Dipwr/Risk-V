/* ============================================================================
 * RV32I BARE-METAL MULTI-BALL PHYSICS SIMULATION (WITH CONTINUOUS SPAWNER)
 * Target: Custom RV32I Single-Cycle Core (320x200 @ Double-Buffered VRAM)
...
#define PAGE_WORDS (SCREEN_WIDTH * SCREEN_HEIGHT) // 64,000 words per VRAM page

// 16-bit RGB 5-5-5 Color Macro
#define MAKE_RGB(r, g, b)                                                      \
  (0x8000 | (((r)&0x1F) << 10) | (((g)&0x1F) << 5) | ((b)&0x1F))

#define COLOR_BLACK 0x8000
#define COLOR_WHITE MAKE_RGB(31, 31, 31)
#define COLOR_GRAY MAKE_RGB(15, 15, 15)
#define COLOR_RED MAKE_RGB(31, 6, 6)
#define COLOR_GREEN MAKE_RGB(6, 31, 6)
#define COLOR_BLUE MAKE_RGB(8, 18, 31)
#define COLOR_YELLOW MAKE_RGB(31, 31, 6)
#define COLOR_CYAN MAKE_RGB(6, 31, 31)
#define COLOR_MAGENTA MAKE_RGB(31, 6, 31)
#define COLOR_ORANGE MAKE_RGB(31, 18, 2)
#define COLOR_LIME MAKE_RGB(18, 31, 2)

// ----------------------------------------------------------------------------
// 2. REQUIRED RV32I SOFTWARE MATH RUNTIME HELPERS
// ----------------------------------------------------------------------------
...
// Unsigned 32-bit Modulo (__umodsi3) - Fixes missing symbol error!
...
// ----------------------------------------------------------------------------
// 3. FIXED-POINT Q16.16 ARITHMETIC & MATH FUNCTIONS
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// 4. GRAPHICS RENDERER (EUCLIDEAN SPAN ROUND CIRCLES & SPAWNER PIPE)
// ----------------------------------------------------------------------------
...
void draw_filled_circle(int page, int cx, int cy, int radius, uint32_t color) {
  int r2 = radius * radius;
  uint32_t page_base = page * PAGE_WORDS;
...
// ----------------------------------------------------------------------------
// 5. PHYSICS ENGINE & CONTINUOUS SPAWNER LOGIC
// ----------------------------------------------------------------------------
#define MAX_BALLS 40
...
static const uint32_t palette[8] = {COLOR_RED,    COLOR_GREEN, COLOR_BLUE,
...
int main(void) {
  ...
  print_string(
      "[RV32I Core] Continuous Top-Right Spawner Simulation Active...\n");
  ...
  print_string("[RV32I Core] Exiting, returning control to Wozmon.\n");
  *PAGE_REG = 0;
  return 0;
}